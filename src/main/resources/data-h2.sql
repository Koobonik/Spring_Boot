...
insert into posts (title, author, content, created_date, modified_date) values ('테스트3', 'test3@gmail.com', '테스트3의 본문', now(), now());
insert into account (created_date, modified_date, userid, userpassword) values (now(), now(), 'hellouser', 'password123');